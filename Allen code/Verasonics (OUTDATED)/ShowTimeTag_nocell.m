...
numFrames = size(RcvData, 3);  % number of frames in Rcv buffer 1 in Matlab Workspace
...
% figure; plot(TimeTagValues - TimeTagValues(1))
% figure; plot(TimeTagValues)
hold on; plot(TimeTagValues)
