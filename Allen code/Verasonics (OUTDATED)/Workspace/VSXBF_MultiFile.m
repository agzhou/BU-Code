...
prompt={'Processing start file','nFile/nRepeat to process','CP start', 'nCP','PDelta-X',...
         'PDelta-Z'};
name='Beamforming';
defaultvalue={BFinfo.fileInfo{8}(1:end-4),'1','1','1','0.5','0.5'};
...
%         TGC.CntrlPts = [700,830,900,950,995,1000,1000,1000]; % original
        TGC.CntrlPts = [750,820,880,910,970,980,1000,1000]; % save rf
...
%                 Receive(rcvNum).Apod(:)=1;
        ...
        disp([ filename ': NOTE -- Running VSX automatically!']), disp(' ')
        VSXBF
