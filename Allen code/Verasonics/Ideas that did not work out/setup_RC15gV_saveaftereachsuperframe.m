...
savepath = "G:\Allen\Data\11-21-2024 RC15gV saving tests\trial 4\";
...
fps_target = 2380;   % Intended frame rate

numChannels = 256; % enable all channels

% numSupFrames = 6; % # of superframes, MUST BE ONE OR EVEN FOR VSX
% numSubFrames = 40; % # of subframes
numSupFrames = 6; % # of superframes, MUST BE ONE OR EVEN FOR VSX
numSubFrames = 10; % # of subframes
