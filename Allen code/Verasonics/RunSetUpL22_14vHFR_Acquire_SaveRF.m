...
addpath 'C:\Users\BOAS-US\Documents\Allen\GitHub\BU-Code\Previous lab code'
load('C:\Users\BOAS-US\Documents\Allen\GitHub\BU-Code\Previous lab code\Mains\DAQParameters.mat')
...
P.t2NextPlaneDAQ=33;%58*2; % for PDI: 58*2 for 500Hz 17angles;58*1 for 1kHz 17angles;    % us, time-to-next acquisition between successive plane wave, travel time + system overhead time, the default is 33 us for 150 wavelengths acquisition
...
SeqControl(6).argument = min(P.t2NextSupPlaneDAQ-t2NextCCPlaneDAQ*P.numCCframes+10,4e6);  % in us; time for data trasfer to host, amd to next superframe/PDI acquisition
