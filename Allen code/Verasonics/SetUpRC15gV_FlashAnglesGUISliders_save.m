...
savepath = "G:\Allen\Data\12-18-2024 microbubbles\RC15gV\run 6 1.6v live\";
...
Process(4).method = 'saveRcvData_quick'; % Function name
...
% angles = TX(1:na).Steer;
% angles = (P.startAngle+ dtheta/na .* 1:na)
% if na >= 2 
%     angles = linspace(P.startAngle, -P.startAngle, na);
% else
%     angles = 0;
% end
% startDepth = P.startDepth;
