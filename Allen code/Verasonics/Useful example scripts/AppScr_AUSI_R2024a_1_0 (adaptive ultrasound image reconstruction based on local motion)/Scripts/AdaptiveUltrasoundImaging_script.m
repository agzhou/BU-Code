%
% File name: AdaptiveUltrasoundImaging_script.m - Example of reconstruction
%            based on local motion detection using two different interleaved 
%            transmits
%
% Description:
...
%  was detected using speckle tracking and pixels were classified into fast-motion
%  and slow-motion regions. The slow-motion region was reconstructed using 
%  accumulation of IQ data from 48 wide focused beams acquisitions, while 
%  fast motion region was reconstructed using flash plane wave acquisitions. 
...
save('MatFiles/L11-5gH_AUSI_sequence');
return
