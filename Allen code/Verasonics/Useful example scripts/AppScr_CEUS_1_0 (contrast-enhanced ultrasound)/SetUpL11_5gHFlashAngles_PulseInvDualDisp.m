% File name: SetUpL11_5gHFlashAngles_PulseInvDualDisp.m - Example of 
...
%   pulse inversion.  
%   The scripts transmit and receives using all 128 channels available on 
%   the L11-5gH probe 
%
...
%       TX-freq:11 MHz, PI TX-freq:5.5 MHz )
...
TWfreq = 5.5;       % transmit frequency (set lower than Trans.frequency for harmonic imaging)
...
Resource.RcvBuffer(2).rowsPerFrame = 2*na*4096; % this size allows for maximum range
...
save('MatFiles/L11-5gHFlashAngles_PulseInvDualDisp');
