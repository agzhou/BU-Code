...
savepath = "G:\Allen\Data\12-03-2024 RC15gV saving tests\trial 1 exp\";
...
Resource.RcvBuffer(1).numFrames = 1; % minimum # frames of RF data to acquire; RcvBuffer contains all the data needed for a whole frame, including multiple acquisition passes needed for reconstruction. Software can re-process RcvBuffer frames
