...
%% Description
% Verasonics reconstruction of RF data with the L22-14v probe
...
% 
% path = 'G:\Allen\Data\12-06-2024 RC15gV AZ001 baseline\trial 2\';
% 
% % if ~exists('base', 'P')
% load([path, 'params.mat'])
% load([path, 'RC15gV-RcvData-30-21-2000-50-4-60'])
...
Receive = repmat(struct('Apod', ones(1, Trans.numelements), ... 
                        ...
                        'callMediaFunc', 0, ...
                        'LowPassCoef', [], ...
                        'InputFilter', []), 1, P_new.numSupFrames*P_new.numSubFrames*na);
j = 1;
% an = 0;
...
filename = 'L22_14v_Allen_recon.mat';
...
toc
%% 
IQ = squeeze(IData{1} + 1i .* QData{1});
figure; imagesc(abs(squeeze(IQ(:, :, 1))))
