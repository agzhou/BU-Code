...
function [Mcr_triggerSignal] = generateSingleTriggerSignal(daqrate, delay_s, pulse_width_s)
%     % testing
...
%     total_duration_s = 5;
    ...
    voltageHigh = 5; % 5 V default for a high signal, could add a varargin for this
%     Mcr_triggerSignal = zeros(total_duration_s * daqrate, 1);
    Mcr_triggerSignal = zeros((delay_s + pulse_width_s * 2) * daqrate, 1); % The x2 is to add some buffer room after
