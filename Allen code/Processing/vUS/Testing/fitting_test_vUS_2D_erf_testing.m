...
% Use some fixed values to create an M that is "separate" from v_zgp
v_xgp_M = 0.05; % m/s
v_zgp_M = 0.01; % m/s
M = v_xgp_M^2./sigma(1).^2 + v_zgp_M^2./sigma(2).^2;

% Tune v_zgp separately
v_zgp = 0.01;

[g1_erf] = vUS_2D_erf_M_vzgp_separability(tau, k0, sigma, M, v_zgp);
