...
% lsqnonlin, in the 2D vUS fitting with my new g1 model, with the numerically
% integrated general form (k, a free)

% Optional input: OF_weight: [nTau, 1]

function [obj_fun] = vUS_2D_num_OF(x, tau, k0, sigma, g1_exp_split, OF_weight)
    if nargin > 5
    ...
    splitOrNot = true;
    [g1_split] = vUS_2D_num_wrapper(x, tau, k0, sigma, splitOrNot);
