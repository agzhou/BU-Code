...
figure; imagesc(squeeze(max(mean(abs(IQf_separated{1}), 4), [], 1))')
figure; imagesc(squeeze(max(mean(abs(IQf_separated{2}), 4), [], 1))')
figure; imagesc(squeeze(max(mean(abs(IQf_separated{3}), 4), [], 1))')
%% ========= 4. Clean data ========= %%
