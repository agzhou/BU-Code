...
% lsqnonlin, in the 3D vUS fitting with my new g1 model, using an
% analytical Jacobian and the Transverse velocities Combined

% Optional input: OF_weight: [nTau, 1]

function [obj_fun, J] = vUS_3D_TC_OF(x, tau, k0, sigma, g1_exp_split, OF_weight)
    if nargin > 6
