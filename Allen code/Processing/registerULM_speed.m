...
load('D:\Allen\Data\AZ02 Stroke ULM RC15gV\03-17-2025 baseline right eye\ULM processing results\Pairing and tracking all files\speed_maps.mat')
load('D:\Allen\Data\AZ02 Stroke ULM RC15gV\04-15-25 1h left eye\ULM processing results\Pairing and tracking results\speed_maps.mat')
load('D:\Allen\Data\AZ02 Stroke ULM RC15gV\04-18-2025 3d right eye\ULM processing results\Pairing and tracking results\speed_maps.mat')
load('D:\Allen\Data\AZ02 Stroke ULM RC15gV\04-22-2025 7d left eye\ULM processing results\Pairing and tracking results\speed_maps.mat')
...
figure; imagesc(squeeze(max(baselineBDM(yr, :, :), [], 1))' .^ mipPower); colormap hot
...
figure; imagesc(squeeze(max(day7BDM(yr, :, :), [], 1))' .^ mipPower); colormap hot
figure; imagesc(squeeze(max(day7BDM(:, :, :), [], 1))' .^ mipPower); colormap hot
...
% generateTiffStack_multi(volumeDataGammaCompressed2, [8.8, 8.8, 8], 'hot', 10)

volumeDataGammaCompressed3 = {hour1BDM .^ 0.5, day7BDM_registered .^ 0.5};

volumeDataGammaCompressed4 = {baselineBDM_registered .^ 0.5, hour1BDM .^ 0.5, day3BDM_registered .^ 0.5, day7BDM_registered .^ 0.5};
