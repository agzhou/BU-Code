function rect = roi_rect(varargin)
...
%         CleanGlobals;
%         eid = 'Images:roi_rect:expectedHandle';
...
%     end
    ...
    otherwise
        CleanGlobals;
        eid = 'Images:roi_rect:expectedFigureOrAxesHandle';
...
set(GETRECT_FIG, ...
    'Pointer', 'crosshair', ...
    'WindowButtonDownFcn', 'roi_rect(''ButtonDown'');', ...
    'DoubleBuffer', 'on');
...
case 'trap'
    ...
    eid = 'Images:roi_rect:interruptedMouseSelection';
...
set(GETRECT_FIG, 'WindowButtonMotionFcn', 'roi_rect(''ButtonMotion'');', ...
                 'WindowButtonUpFcn', 'roi_rect(''ButtonUp'');');
