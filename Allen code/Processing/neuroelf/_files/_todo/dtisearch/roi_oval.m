function rect = roi_oval(varargin)
...
%         CleanGlobals;
%         eid = 'Images:roi_oval:expectedHandle';
...
%     end
    ...
    otherwise
        CleanGlobals;
        eid = 'Images:roi_oval:expectedFigureOrAxesHandle';
...
set(GETRECT_FIG, ...
    'Pointer', 'crosshair', ...
    'WindowButtonDownFcn', 'roi_oval(''ButtonDown'');', ...
    'DoubleBuffer', 'on');
...
% 
% t = 0:pi/20:2*pi; 
% XData = x_RO*cos(t)+x_center; 
% YData = y_RO*sin(t)+y_center; 
...
case 'trap'
    ...
    eid = 'Images:roi_oval:interruptedMouseSelection';
...
set(GETRECT_H1, 'XData', xdata, ...
                'YData', ydata, ...
                'Visible', 'on','LineWidth',1);
set(GETRECT_H2, 'XData', xdata, ...
                'YData', ydata, ...
                'Visible', 'on','LineWidth',1);

% Let the motion functions take over.
set(GETRECT_FIG, 'WindowButtonMotionFcn', 'roi_oval(''ButtonMotion'');', ...
                 'WindowButtonUpFcn', 'roi_oval(''ButtonUp'');');
