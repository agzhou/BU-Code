...
SSTO = sum(X(:,1).^2);  %total sum of squares
...
SSA = sum(A);  %sum of squares for the IV1
...
SSEA = sum(EIV1)-sum(A)-sum(S);  %sum of squares of the IV1-error
...
SSB = sum(B);  %sum of squares for the IV2
...
SSEB = sum(EIV2)-sum(B)-sum(S);  %sum of squares of the IV2-error
...
SSC = sum(C);  %sum of squares for the IV3
...
SSEC = sum(EIV3)-sum(C)-sum(S);  %sum of squares of the IV3-error
...
SSAB = sum(AB)-sum(A)-sum(B);  %sum of squares of the IV1xIV2
...
SSEAB = sum(EIV12)-sum(AB)-sum(EIV2)+sum(B)-sum(EIV1)+sum(A)+sum(S);
...
SSAC = sum(AC)-sum(A)-sum(C);  %sum of squares of the IV1xIV3
...
SSEAC = sum(EIV13)-sum(AC)-sum(EIV3)+sum(C)-sum(EIV1)+sum(A)+sum(S);
...
SSBC = sum(BC)-sum(B)-sum(C);  %sum of squares of the IV2xIV3
...
SSEBC = sum(EIV23)-sum(BC)-sum(EIV3)+sum(C)-sum(EIV2)+sum(B)+sum(S);
...
SSABC = sum(ABC)+sum(A)+sum(B)+sum(C)-sum(AB)-sum(AC)-sum(BC);  %sum of squares of the IV1xIV2xIV3
...
SSEABC = sum(EIV123)-sum(ABC)-sum(EIV23)+sum(BC)-sum(EIV13)+sum(AC)+sum(EIV3)-sum(C)-sum(EIV12)+sum(AB)+sum(EIV2)-sum(B)+sum(EIV1)-sum(A)-sum(S);  %sum of squares of the IV1-IV2-IV3-error
