...
% function [centroidCoordinates] = localizeBubbles2D(IQf, refPSF, range, imgRefinementFactor, binaryThreshold, areaThreshold)
    ...
    centers = imregionalmax(XCt); % Center of each isolated blob (logical matrix)
