    ...
    switch whatToReturn
        ...
        case 'compounded'
            ...
            for j = 1:n
                ...
                tempAngleTX = anglesTXKept(j, :);
                tempAngleRX = anglesRXKept(j, :);
                ...
                [verytemp] = applyTimeDelays(nx, ny, nz, ns, tempLUTTX, tempLUTRX, param, squeeze(RawDataKK(:, find(anglesTX(1:naTX/2, 1) == tempAngleTX(1)), find(anglesRX(1:naRX/2, 2) == tempAngleRX(2)))), interp_method);
            ...
            for j = 1:n
                disp(n + j)
                tempAngleTX = anglesTXKept(n + j, :);
                tempAngleRX = anglesRXKept(n + j, :);
                tempLUTTX = genLUT(tempAngleTX, BFgrid, param.c);
                tempLUTRX = genLUT(tempAngleRX, BFgrid, param.c);
