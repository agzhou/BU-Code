function [eConstruct,eConstructSum,eDelay] = BeamformKK2(RawDataKK, tBegin, tSpan, xSize, TXangle, RXangle, s)
    ...
    for nR=1:RXSize
        ...
        for nt=1:tSpan
            for nx=xMin(nt,nR):xMax(nt,nR)
                delay=(zRXcos(nt,nR)+zTXcos(nt,nT)+xRXsin(nx,nR)+xTXsin(nx,nT));
