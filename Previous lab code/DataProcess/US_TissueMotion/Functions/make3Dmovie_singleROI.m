function make3Dmovie_singleROI(Xmovi,zShiftPix,xShiftPix,ImgInfo)
...
% ImgInfo.t = 500/1000; time duration: frames# / framerate
%
...
for i = 1 : nf
    % make a movie
    imagesc(Xmovi(:,:,i)); axis image; colormap(jet); colorbar; hold on;
    caxis([cmin, cmax]); 
    hColorbar = colorbar;
    ...
    hold on;
    quiver(nx/2,ny/2, zShiftPix(i),xShiftPix(i),'b')
    hold off;
%    pause (1)
    vframe = getframe(gcf); 
