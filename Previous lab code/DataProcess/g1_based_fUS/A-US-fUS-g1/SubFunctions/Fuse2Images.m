function Fuse2Images(img_bk,img_olap, cRangeBk,cRangeOlap, shhold)
%% %%%%%%%%%%%%% example %%%%%%%%%%%%%%%%%%%%%%%%
% xCoor=1:512;
% zCoor=1:320;
...
% plot overlap figure
h1=imagesc(img_olap);
alpha(h1,0.7*double((img_olap)>shhold)); % -mean(mean(img_olap)), transparency settings
caxis(hAxes2,cRangeOlap);
%set colormap for overlap axes
colormap(hAxes2,hot);% VzCmapDn);
axis equal
axis tight
