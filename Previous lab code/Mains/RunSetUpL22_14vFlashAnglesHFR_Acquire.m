...
%%%%
cd C:\Users\BOAS-US\Desktop\Vantage-3.4.3-1807021300\ % C:\Users\BOAS-US\Documents\Vantage-4.4.0-2012091800 %  %C:\Users\BOAS-US\Documents\Vantage-3.4.0-1711281030
...
prompt={'File name:',...
    ...
    'Receive Start Depth, [Lamda ~98um]:',...
    'Receive End Depth, [Lamda: ~98um]:',...
    'TW frequency [MHz]',...
...
P.t2NextPlaneDAQ=58*2;    % us, time interval between successive plane wave, travel time + system overhead time, the default is  us for 150 wavelengths acquisition
...
%     prompt={['Incorrect superFrame rate, Approriate Range: ', num2str(1e6/(tCCUS*P.numCCframes+4e6)) ,'-',num2str(1e6/(tCCUS*(P.numCCframes)+0.1e6))]}; % 100ms to 4s
...
%% time intervale between plane wave emission
P.t2NextPlaneDAQ= 33;%58*2;%;%58*2;    % us, time interval between successive plane wave, travel time + system overhead time, the default is 33 us for 150 wavelengths acquisition
tCCUS=round(1e6/P.CCFR); % Time intervale between successive CCUS frame,us 
...
TX = repmat(struct('waveform', 1, ...
                   ...
                   'focus', 0.0, ...
                   'Steer', [0.0,0.0], ...
                   'Delay', zeros(1,128)), 1, P.numAngles);    %Resource.Parameters.numTransmit
...
TGC.CntrlPts = [800,880,940,980,1000,1000,1000,1000];
...
% rcvElem(45:84)=1;
Receive = repmat(struct('Apod',  rcvElem, ...%                  'Aperture', 17,...
...
SeqControl(6).argument = P.tIntPDI-tCCUS*P.numCCframes+10;  % in us; time for data trasfer to host, amd to next superframe/PDI acquisition
...
if simulateMode ~= 2    
    ...
    savefast ([savepath,RFdataFilename], 'IQ','RFRAW','P')
