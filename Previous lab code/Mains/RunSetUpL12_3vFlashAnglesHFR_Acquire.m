...
P.Filename=Filename;
save('D:\CODE\Mains\DAQParameters_L12_3v.mat','DAQInfo');
...
Resource.Parameters.connector = 2;   %***2
...
PData.PDelta = [Trans.spacing/4, 0, 0.25]; % [trans.spacing,,0.5]
...
TW.Parameters = [P.TWfrequency, 0.67, P.TWnHC, 1];   % 6 MHz center frequency, 67% pulsewidth 1.5 cycle burst
...
ReconInfo = repmat(struct('mode', 'accumIQ', ...  % default is to accumulate IQ data.%                     'Aperture', [65:128], ...
                   'txnum', 1, ...
                   'rcvnum', 1, ...
