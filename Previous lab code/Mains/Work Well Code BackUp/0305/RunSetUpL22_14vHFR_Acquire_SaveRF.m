...
if P.tIntPDI-tCCUS*P.numCCframes<0 || (P.tIntPDI-tCCUS*P.numCCframes)>4e6
    P.tIntPDI=tCCUS*(P.numCCframes)+2.5e6;
    P.PDIFR=1e6/P.tIntPDI;
    prompt={['Incorrect superFrame rate, Approriate Range: ', num2str(1e6/(tCCUS*P.numCCframes+4e6)) ,'-',num2str(1e6/(tCCUS*(P.numCCframes)+2.5e6))]};
...
TGC.CntrlPts = [800,920,970,980,990,1000,1010,1012];
