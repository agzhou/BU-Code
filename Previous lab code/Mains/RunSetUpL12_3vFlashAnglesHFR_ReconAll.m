...
cd C:\Users\BOAS-US\Desktop\Vantage-3.4.3-1807021300
...
if simulateMode ==2
    ...
    save('D:\CODE\Mains\DAQParameters_L12_3v.mat','DAQInfo','P');
...
TW.Parameters = [6, 0.67, 3, 1];   % 18 MHz center frequency, 67% pulsewidth 1.5 cycle burst
...
TX = repmat(struct('waveform', 1, ...
                   ...
                   'focus', 0.0, ...
                   'Steer', [0.0,0.0], ...
                   'Delay', zeros(1,Resource.Parameters.numRcvChannels)), 1, P.numAngles);
...
Receive = repmat(struct('Apod', zeros(1,Resource.Parameters.numRcvChannels), ...
                        'aperture', 1, ...
...
%         Receive(rcvNum).Apod(:)=1;
        Receive(rcvNum).Apod(65:128)=1; %% NOTE: CHANGE HERE
...
SeqControl(6).argument = min(P.tIntPDI-tCCUS*P.numCCframes,4e6);  % in us; time for data trasfer to host, amd to next superframe/PDI acquisition
