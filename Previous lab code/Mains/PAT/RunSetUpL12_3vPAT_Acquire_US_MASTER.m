% File name: RunSetUpL22_14VPAT_Acquire_US_MASTER.m
% Description: 
...
load('X:\Matlab code\PATAQParameters.mat');
...
TX(1).Apod = ones(1,Resource.Parameters.numTransmit);  % zeros(1,Trans.numelements);
TX(1).Delay = zeros(1,Resource.Parameters.numTransmit); %computeTXDelays(TX(1));
...
SeqControl(6).argument = 10e6; % Wait 30 seconds
