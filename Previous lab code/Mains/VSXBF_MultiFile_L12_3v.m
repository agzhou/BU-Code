...
load('D:\CODE\Mains\DataProcessingPath_L12_3v.mat');
...
save('D:\CODE\Mains\DataProcessingPath_L12_3v.mat','DefaultPath')
%%
...
for iCP=BFinfo.PreCP:BFinfo.nCP
    ...
    for iFile=BFinfo.PreFile:BFinfo.startFile+BFinfo.nFile-1
        ...
        save(['D:\CODE\Mains\','BFinfo_L12_3v.mat'],'BFinfo','iFile','iCP')
        %%
        clear all % required by VSX
        load(['D:\CODE\Mains\','BFinfo_L12_3v.mat']);
