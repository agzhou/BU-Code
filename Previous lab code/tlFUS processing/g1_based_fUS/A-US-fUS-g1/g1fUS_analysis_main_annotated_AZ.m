...
% get normalized data 
%%%%%%%%% of the median of the planar timecourses across the trial dimension %%%%%%%%%
%%%%%%%%% normalize the median across trials, using the 'norm' method,
        %  across time within the trial duration %%%%%%%%%
