 ...
 function outputData = generateStimulus(Absolute_Beginning_Stimulus_Delay_Seconds,Stimulus_Frequency_Hz...
    ,SingleStimulusPulseDurationSeconds,StimulateForHowManySeconds_InOneSequence, Total_One_Sequence_Duration_Seconds)
...
%      Baseline_Delay_ch2 = 0;
    ...
    Output_DAQ_Frequency_Hz=1000;% sample rate is 10 kHz for output 
    ...
    Number_Points_Absoulte_Beginning = (Absolute_Beginning_Stimulus_Delay_Seconds*Output_DAQ_Frequency_Hz); % P
