...
% High frame rate
parameterDefaults = {'30', '0', '8', '45000', '5000', '5', '6', '15.625', '1540', '0', '1', '1000', '0', 'UTA-260D', '1.45', '10', '1.5', '200', '3'}; % 1.45 GB/s is the default for the current Samsung MZVKW1T0HMLH-000L7 drives
% Continuous
% parameterDefaults = {'30', '0', '8', '45000', '400', '5', '6', '15.625', '1540', '0', '1', '400', '0', 'UTA-260D', '1.45', '10', '1.0', '200', '3'}; % 1.45 GB/s is the default for the current Samsung MZVKW1T0HMLH-000L7 drives
% parameterDefaults = {'30', '0', '8', '45000', '800', '5', '6', '15.625', '1540', '0', '1', '800', '0', 'UTA-260D', '1.45', '10', '1.0', '200', '3'}; % 1.45 GB/s is the default for the current Samsung MZVKW1T0HMLH-000L7 drives
% Matt continuous
% parameterDefaults = {'30', '0', '8', '45000', '400', '11', '5', '15.625', '1540', '0', '1', '400', '0', 'UTA-260D', '1.45', '10', '1.0', '200', '3'}; % 1.45 GB/s is the default for the current Samsung MZVKW1T0HMLH-000L7 drives
...
Receive = repmat(struct('Apod', rcvElem, ... 
                        ...
                        'callMediaFunc', 0, ...
                        'LowPassCoef', [], ...
                        'InputFilter', BPF1), 1, numFramesPerSF * na * numBuffers);
j = 1;
% an = 0;
...
%         Event(n).seqControl = [4, scInd - 1, scInd];
    ...
    % Transfer the previously acquired buffer/superframe
    scInd = scInd + 1; 
...
filename = 'L22_14v_Allen_loop_functional_buffers.mat';
