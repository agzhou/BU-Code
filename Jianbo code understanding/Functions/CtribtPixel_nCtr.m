...
function [indLtravel,Apod]=CtribtPixel_nCtr(iP,nElem,x,z)
...
% nElem=number of contributing transducer element: reconstruction numerical aperture
...
Apod= ceil(abs((x-xElem)/iP.pitch)) < nElem ;                                               % apodisation aperture
